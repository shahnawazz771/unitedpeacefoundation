        ...
        <div class="col-md-12">
          <nav role="navigation" class="navbar navbar-default"> 
            ...
            <div class="navbar-header col-md-2">
              ...
              <a class="navbar-brand" href="index.php"><img src="images/logo1.gif" width="100%"></a>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-7">
              <div class="collapse navbar-collapse" id="navbar-collapse">
                <a href="javascript:void(0)" class="header-bar-icon" res-action="y"><i class="fa fa-bars"></i></a>
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown programme"><a class="dropdown-toggle" data-toggle="dropdown" href="#">programme <span class="caret"></span></a>
                    <ul class="dropdown-menu dropdown-menu-left dropdown-3rd">
                      ...
                      <li><a href="food-program.php?page=programme">Food programme</a></li>
                    </ul>
                  </li>
