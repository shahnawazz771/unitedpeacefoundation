<nav>
    ...
    <label class="logo">
      <a class="img-header" href="index.php?page=home"><img src="images/logo1.gif">
        <h3 class="logo-head">United Peace Foundation</h3>
        <span class="log-head-slogan">A small step towards orphans</span>
      </a>
    </label>
    <ul>
      ...
      <!-- <li class="home"><a href="javascript:void(0)" class="nav-li">Test <span class="caret"></span></a>
        <ul class="nested-nav">
          ...
          <li class="nested-nav-li">Test 2</li>
        </ul>
      </li> -->
      ...
      <li class="dropdown programme"><a class="dropdown-toggle" data-toggle="dropdown" href="#">programme <span class="caret"></span></a>
        <ul class="dropdown-menu dropdown-menu-left dropdown-3rd four-line">
          ...
          <li><a href="programme.php?page=programme&programme=emergency-relief">Emergency Relief</a></li>
        </ul>
      </li>
